...
{else}
    ...
    <form method="post" action="creditcard.php?" class="form-horizontal" role="form" id="mainfrm">
            ...
            <div class="col-md-7">
                ...
                <div class="form-group">
                    <div class="text-center">
                        <input type="submit" id="checkoutbutton"  class="btn btn-primary btn-lg" value="{$LANG.submitpayment}" id="btnSubmit" />
                    </div>
                </div>
