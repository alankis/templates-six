...
<div class="tab-content margin-bottom">
	...
	<div class="tab-pane fade" id="tabWhoisid">
		...
		<div class="internalpadding">
			...
			{else}
			<form method="post" action="{$smarty.server.PHP_SELF}?action=domaincontacts#tabWhoisid">
				...
				<table class="table table-hover">
					...
					<tr>
						<td style="vertical-align: middle;">
							<input name="privacystatus" class="form-control" type="checkbox" {if $isprivacyon eq "true"} checked="checked"{/if}/>
						</td>
						<td>
