...
<head>
    ...
    <script type="text/javascript" src="templates/{$template}/js/jquery.validate.min.js"></script>
    <script type="text/javascript" src="templates/{$template}/js/validation.js"></script>
    <link href="templates/{$template}/css/validation.css" rel="stylesheet" />
</head>
<body>
...
<section id="header">
    <div class="container">
        ...
        <div id="top-nav">
            ...
            {*<!-- Template Name -  For easier debugging -->
             <div class="pull-right nav">
                <a href="#" class="quick-nav"><i class="fa fa-cog"></i> <span class="hidden-xs">Template name: {$template}</span><span class="hidden-xs"></span></a>
            </div> *}
        ...
        <a href="{$WEB_ROOT}/index.php"><img src="{$WEB_ROOT}/templates/{$template}/img/infonet-logo.png" alt="{$companyname}" /></a>
